...
const motivationalTexts = [
    "Push your limits. Watch them break.",
...
const BrandShowcase = () => {
    ...
    // Typewriter effect
    useEffect(() => {
        const currentFullText = motivationalTexts[currentTextIndex]
    ...
    return (
        <div id="brandShowcase">
            <div className='brandShowcase-content'>
                <h1 className="brandShowcase-title">Start Your Journey With Runavo.</h1>
                ...
                <div className="suzuka-container">
                    <svg viewBox="0 0 304 112" className="suzuka-svg">
                        <title>Suzuka</title>
                    ...
                    <div ref={carRef} className="car"></div>
                </div>
            </div>
        </div>
    )
